        ...
        <div className="bg-white border-b border-gray-200 px-4 md:px-6 py-4 md:py-6">
          <div className="flex flex-col gap-2">
            <nav className="text-sm text-gray-500">
              <span className="text-gray-900">Plataforma</span>
            </nav>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Bem-vindo à plataforma de análise de contratos</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white border-b border-gray-200 px-4 md:px-6 py-4 md:py-6">
        <div className="flex flex-col gap-2 max-w-6xl mx-auto">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl md:text-2xl font-bold text-gray-900">Dashboard</h1>
              <p className="text-sm text-gray-600">Visão geral das suas análises e contratos</p>
            </div>
          </div>
        </div>
      </div>
